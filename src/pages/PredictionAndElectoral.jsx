  ...
  return (
    <div className="">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="An Electoral College of 538 delegates decides who occupies the White House. Our game lets you pick state winners and whoever gets 270 votes gets to rule The Free World."
        />
        <meta lang="en" />
      </Helmet>
      <AppBanner
        ...
        bannerDesc={
          <>
            ...
            <br />
            538 delegates to the Electoral College decide
            <br />
          </>
        }
        bannerDesc2={
          <>
            ...
            <br />
            Start by predicting each party’s candidates
            <br />
            Then predict which party wins each state
            <br />
            This is will determine the 538 delegates to the Electoral College
          </>
        }
      />
        ...
        <div>
          <div className="relative">
            ...
            <p className="absolute right-0 top-[7px] text-[10px] w-[52%] text-white">
              Select leading Independent or <br />
              third party on election day
            </p>
          </div>
          <Predict
            name={"Independent"}
