  ...
  return (
    <div className="">
      ...
      <div className="buttons flex items-center justify-center gap-4 xl:mt-[54px] mb-3 ">
        ...
        <button onClick={sendPrediction} disabled={!isSelectionComplete} className={`rounded-[6px] text-white poppins-6 border-[1px] border-redish px-10 py-2 bg-redish ${!isSelectionComplete?"opacity-40":""}`}>Submit your prediction</button>
      </div>
      <DownloadApp />
    </div>
  );
