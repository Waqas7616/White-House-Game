    ...
    useEffect(() => {
        if (predict === 1) {
            ...
            setPartyData((prev) => ({
                ...
                vice_president_id: candidateData?.chosen_candidate?.[1]?.voter_candidate_id
            }));
        } else if (predict === 2) {
            setPartyData((prev) => ({
                ...prev,
                ...
                vice_president_id: candidateData?.chosen_candidate?.[3]?.voter_candidate_id
            }));
        } else {
            setPartyData((prev) => ({
                ...prev,
                ...
                vice_president_id: candidateData?.chosen_candidate?.[5]?.voter_candidate_id
            }));
        }
    }, [predict, candidateData]);

    const sendPartyData = () => {
        axios.post('https://pankhay.com/thewhitehousegame/public/api/predict_party_leader',
            partyData,
            {
                headers: {
                    Authorization: `Bearer ${token}`,
