                ...
                <div className="resp m-auto w-10/12">
                    ...
                    <div className="contact-form mt-8 flex gap-4 items-start mb-20 ">
                        <div className="form basis-[70%] ">
                            ...
                            <textarea placeholder='Message' rows={12} className='outline-none border-[1.5px] border-[#dedede] rounded-[4px] px-4 py-2 w-full mt-3 text-[#757575] poppins4 text-[16px]' />
