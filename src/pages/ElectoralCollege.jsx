      ...
      <div className="voting w-10/12  resp m-auto py-[102px] bg-[#1c2452]">
        <div className="state-data  mb-[110px] m-auto px-[120px] h-64 bg-redish rounded-[18.06px] relative flex justify-evenly items-center">
          ...
          <div className="info flex justify-center gap-5 items-center">
            ...
            <div className="name">
              <h6 className="poppins6 text-white text-[33px]">
                {previousData?.states?.[step]?.name}
              </h6>
              <p className="poppins4 text-white text-[28px]">
        ...
        <div className="question relative px-[120px] py-16 bg-[#131A41] rounded-[18.06px]">
          ...
          />
          <h4 className="text-white text-center poppins6 text-[36px]">
            Who do you predict will win?
          </h4>
          <h2 className="text-white text-center poppins6 text-[47.4px]">
            {previousData?.states?.[step]?.name}
          </h2>
        </div>
        ...
        <button
          onClick={handleSteps}
          className="btn bg-redish m-auto w-[346px] block px-8 mb-[108px] ] py-2 text-white uppercase rounded-[6px]"
        >
        ...
        <div className="result-card ">
          <h2 className="text-white mb-12 poppins6 text-[56.4px]">
            Past results
          </h2>
          <div className="result rounded-[10.65px] bg-[#131A41] px-8 py-5">
            <div className="2020">
              ...
              <div className="flex  bg-[#131A41] rounded-[10.65px] mb-[23px]">
                <div
                  className={`py-6 rounded-l-[10.65px] px-4 bg-[#5b4fd1] w-[] flex justify-between items-center`}
                  style={{
                    width: `${previousData?.states?.[step]?.previous_election_state?.[0]?.vote_percentage}%`,
                  }}
                >
                  <p className="text-white poppins4 text-[28px] opacity-70">
                    Democratic
                  </p>
                  <div className="value ">
                ...
                <div
                  className="py-6 flex justify-between relative px-20 items-center rounded-r-[10.65px] bg-white "
                  style={{
                    width: `${previousData?.states?.[step]?.previous_election_state?.[2]?.vote_percentage}%`,
                  }}
                >
                  <p className="poppins6 text-[22px] text-[#131A41] opacity-70 absolute left-1">
                    Others
                  </p>
            ...
            <div className="2016">
              ...
              <div className="flex  bg-[#131A41] rounded-[10.65px] mb-[23px]">
                ...
                <div
                  className="py-6 flex justify-between px-20 relative items-center rounded-r-[10.65px] bg-white "
                  style={{
                    width: `${previousData?.states?.[step]?.previous_election_state?.[5]?.vote_percentage}%`,
                  }}
                >
                  <p className="poppins6 text-[22px] text-[#131A41] absolute left-1 opacity-70">
                    Others
                  </p>
            ...
            <div className="2012 poppins4 text-[42.4px]">
              ...
              <div className="flex  bg-[#131A41] rounded-[10.65px] mb-[23px]">
                ...
                <div
                  className="py-6 flex justify-between px-20 items-center relative rounded-r-[10.65px] bg-white "
                  style={{
