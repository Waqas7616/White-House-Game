...
function ElectoralCollege() {
    const { state_predictions, addPrediction, clearPredictions } = useStatePredictions();
    ...
    useEffect(() => {
        axios.get("https://pankhay.com/thewhitehousegame/public/api/getStateParty", {
            headers: {
            ...
            console.log('Following errors occured while fetching previous data', error)
        })
    ...
    return (
        ...
        <div className=' bg-[#1c2452]' >
            <AppBanner bannerTitle={'College'} redTitle={'Electoral'} bg={electoral} bannerDesc={'Predict the next President of the United States and tell the world what you think!'} />
            ...
            <div className="voting w-10/12  resp m-auto py-[102px] bg-[#1c2452]"  >
                ...
                <div className="question relative px-[120px] py-16 bg-[#131A41] rounded-[18.06px]">
                    <img src={question} alt="" className="absolute top-[-20%] left-[50%] translate-x-[-50%]" />
                    <h4 className='text-white text-center poppins6 text-[36px]'>Who do you predict will win?</h4>
                    <h2 className='text-white text-center poppins6 text-[47.4px]'>{previousData?.states?.[step]?.name}</h2>
                </div>

                <div className="badges my-[77px]">
                    <h6 className="text-white text-right mb-8">{`${step + 1} of ${previousData?.states?.length}`}</h6>
                    <div className="flex justify-between gap-3 ">
                        <div className="democratic rounded-[45px]" onClick={() => handleClick(previousData?.states?.[step]?.id, 1)}>
                            <img src={democratic} className='' alt="" />
                        </div>
                        <div className="republican" onClick={() => handleClick(previousData?.states?.[step]?.id, 2)}>
                            <img src={republican} alt="" />
                        </div>
                        <div className="independent rounded-[45px]" onClick={() => handleClick(previousData?.states?.[step]?.id, 3)}>
                            <img src={independent} alt="" />
                        </div>
                    </div>
                </div>
                <button onClick={handleSteps} className="btn bg-redish m-auto w-[346px] block px-8 mb-[108px] ] py-2 text-white uppercase rounded-[6px]">{step === previousData?.states?.length - 1 ? 'submit' : 'next'}</button>
                ...
                <div className="result-card ">
                    ...
                    <div className="result rounded-[10.65px] bg-[#131A41] px-8 py-5">
                                ...
                                <div className={`py-6 flex justify-between px-4 bg-redish `} style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[1]?.vote_percentage}%` }}>
                                    ...
                                    <div className="value ">
                                        <p className='flex items-center gap-3 poppins4 text-[28px] text-white'>
                                            ...
                                            </svg> {previousData?.states?.[step]?.previous_election_state?.[1]?.vote_percentage}
                                        </p>

                                    </div>
                                </div>
                                <div className="py-6 flex justify-between relative px-20 items-center rounded-r-[10.65px] bg-white " style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[2]?.vote_percentage}%` }}>
                                    <p className='poppins6 text-[22px] text-[#131A41] opacity-70 absolute left-1'>Others</p>
                                    <div className="value poppins4 text-[22px] text-[#131A41] opacity-70">
                                        <p className='flex items-center gap-3 ml-4'>
                                            ...
                                            {previousData?.states?.[step]?.previous_election_state?.[2]?.vote_percentage}
                                        </p>
                        ...
                        <div className="2016">
                            <p className='text-white mb-2 poppins4 text-[42.4px]'>2016</p>
                            <div className="flex  bg-[#131A41] rounded-[10.65px] mb-[23px]">
                                <div className="py-6 rounded-l-[10.65px] px-4 bg-[#5b4fd1]  flex justify-between items-center" style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[3]?.vote_percentage}%` }}>
                                    <p className='text-white poppins4 text-[28px] opacity-70'>Democratic</p>
                                    <div className="value ">
                                        <p className='flex items-center gap-3 poppins4 text-[28px] text-white opacity-70'>
                                            <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </svg> {previousData?.states?.[step]?.previous_election_state?.[3]?.vote_percentage}
                                        </p>

                                    </div>
                                </div>
                                <div className="py-6 flex justify-between px-4 bg-redish " style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[4]?.vote_percentage}%` }}>
                                    <p className='poppins6 text-[28px] text-white'>Republic</p>
                                    <div className="value ">
                                        <p className='flex items-center gap-3 poppins4 text-[28px] text-white'>
                                            <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </svg> {previousData?.states?.[step]?.previous_election_state?.[4]?.vote_percentage}
                                        </p>

                                    </div>
                                </div>
                                <div className="py-6 flex justify-between px-20 relative items-center rounded-r-[10.65px] bg-white " style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[5]?.vote_percentage}%` }}>
                                    <p className='poppins6 text-[22px] text-[#131A41] absolute left-1 opacity-70'>Others</p>
                                    <div className="value poppins4 text-[22px] ml-4 text-[#131A41] opacity-70">
                                        <p className='flex items-center gap-3'>
                                            ...
                                            {previousData?.states?.[step]?.previous_election_state?.[5]?.vote_percentage}
                                        </p>
                        ...
                        <div className="2012 poppins4 text-[42.4px]">
                            <p className='text-white mb-2'>2012</p>
                            <div className="flex  bg-[#131A41] rounded-[10.65px] mb-[23px]">
                                <div className="py-6 rounded-l-[10.65px] px-4 bg-[#5b4fd1]  flex justify-between items-center" style={{ width: `${previousData?.states?.[step]?.previous_election_state?.[6]?.vote_percentage}%` }}>
                                    <p className='text-white poppins4 text-[28px] opacity-70'>Democratic</p>
                                    <div className="value ">
                                        <p className='flex items-center gap-3 poppins4 text-[28px] text-white opacity-70'>
                                            <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </svg>   {previousData?.states?.[step]?.previous_election_state?.[6]?.vote_percentage}
                                        </p>

                                    </div>
                                </div>
                                <div className="py-6 flex justify-between px-4 bg-redish " style={{ width: `  ${previousData?.states?.[step]?.previous_election_state?.[7]?.vote_percentage}%` }}>
                                    <p className='poppins6 text-[28px] text-white'>Republic</p>
                                    <div className="value ">
                                        <p className='flex items-center gap-3 poppins4 text-[28px] text-white'>
                                            <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </svg>   {previousData?.states?.[step]?.previous_election_state?.[7]?.vote_percentage}
                                        </p>

                                    </div>
                                </div>
                                <div className="py-6 flex justify-between px-20 items-center relative rounded-r-[10.65px] bg-white " style={{ width: `  ${previousData?.states?.[step]?.previous_election_state?.[8]?.vote_percentage}%` }}>
                                    <p className='poppins6 text-[22px] text-[#131A41] absolute left-1 opacity-70'>Others</p>
                                    <div className="value poppins4 text-[22px] text-[#131A41] opacity-70">
                                        <p className='flex items-center gap-3 ml-4'>
                                            {/* <svg width="71" height="26" viewBox="0 0 71 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {previousData?.states?.[step]?.previous_election_state?.[8]?.vote_percentage}
                                        </p>
