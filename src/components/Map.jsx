            ...
            <svg className='w-full relative' viewBox="0 0 1020 593" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1_2)">
                    ...
                    <g mask="url(#mask0_1_2)">
                        ...
                        <text x="120" y="500" textAnchor="middle" fill="white" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Alaska').count}`}
                        </text>
                        ...
                        <text x="300" y="560" textAnchor="middle" fill="white" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Hawaii').count}`}
                        </text>
                        ...
                        <text x="650" y="420" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Albama').count}`}
                        </text>
                        ...
                        <text x="535" y="380" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Arkansas').count}`}
                        </text>
                        ...
                        <text x="180" y="350" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Arizona').count}`}
                        </text>
                        ...
                        <text x="70" y="280" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('California').count}`}
                        </text>
                        ...
                        <text x="300" y="280" textAnchor="middle" fill="white" z={999} fontSize="12" fontWeight={700}>
                            {` ${voteCount('Colorado').count}`}
                        </text>
                        ...
                        <text x="860" y="183" textAnchor="middle" fill="black" fontSize="10" fontWeight={700}>
                            {` ${voteCount('Connecticut').count}`}
                        </text>
                        ...
                        <text x="830" y="255" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Delaware').count}`}
                        </text>
                        ...
                        <text x="750" y="500" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Florida').count}`}
                        </text>
                        ...
                        <text x="710" y="420" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Georgia').count}`}
                        </text>
                        ...
                        <text x="500" y="220" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Connecticut').count}`}
                        </text>
                        ...
                        <text x="170" y="150" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Idaho').count}`}
                        </text>
                        ...
                        <text x="580" y="260" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Illinois').count}`}
                        </text>
                        ...
                        <text x="640" y="240" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Indiana').count}`}
                        </text>
                        ...
                        <text x="420" y="280" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Kansas').count}`}
                        </text>
                        ...
                        <text x="650" y="310" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Kentucky').count}`}
                        </text>
                        ...
                        <text x="560" y="480" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Louisiana').count}`}
                        </text>
                        ...
                        <text x="870" y="160" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Massachusetts').count}`}
                        </text>
                        ...
                        <text x="800" y="245" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Maryland').count}`}
                        </text>
                        ...
                        <text x="890" y="80" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Maine').count}`}
                        </text>
                        ...
                        <text x="670" y="180" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Michigan').count}`}
                        </text>
                        ...
                        <text x="500" y="100" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Minnesota').count}`}
                        </text>
                        ...
                        <text x="530" y="300" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Missouri').count}`}
                        </text>
                        ...
                        <text x="590" y="430" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Mississippi').count}`}
                        </text>
                        ...
                        <text x="270" y="80" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Montana').count}`}
                        </text>
                        ...
                        <text x="800" y="330" textAnchor="middle" fill="black" fontSize="12" fontWeight={600}>
                            {` ${voteCount('North Carolina').count}`}
                        </text>
                        ...
                        <text x="400" y="100" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('North Dakota').count}`}
                        </text>
                        ...
                        <text x="405" y="220" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Nebraska').count}`}
                        </text>
                        ...
                        <text x="870" y="140" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('New Hampshire').count}`}
                        </text>
                        ...
                        <text x="835" y="230" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('New Jersey').count}`}
                        </text>
                        ...
                        <text x="300" y="380" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('New Mexico').count}`}
                        </text>
                        ...
                        <text x="130" y="220" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Nevada').count}`}
                        </text>
                        ...
                        <text x="800" y="170" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('New York').count}`}
                        </text>
                        ...
                        <text x="705" y="230" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Ohio').count}`}
                        </text>
                        ...
                        <text x="450" y="360" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Oklahoma').count}`}
                        </text>
                        ...
                        <text x="90" y="120" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Oregon').count}`}
                        </text>
                        ...
                        <text x="790" y="220" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Pennsylvania').count}`}
                        </text>
                        ...
                        <text x="880" y="180" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('Rhode Island').count}`}
                        </text>
                        ...
                        <text x="750" y="380" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('South Carolina').count}`}
                        </text>
                        ...
                        <text x="400" y="160" textAnchor="middle" fill="black" fontSize="12" fontWeight={700}>
                            {` ${voteCount('South Dakota').count}`}
                        </text>
                        ...
                        <text x="400" y="460" textAnchor="middle" fill="black" fontSize="12" fontWeight={600}>
                            {` ${voteCount('Texas').count}`}
                        </text>
                        ...
                        <text x="845" y="130" textAnchor="middle" fill="black" fontSize="12" fontWeight={600}>
                            {` ${voteCount('Vermont').count}`}
                        </text>
