...
function Map() {
    ...
    const [fillColor, setFillColor] = useState('lime')
    const states = [
        { title: 'Alaska', Democratic: 30, Republic: 120, Ind: 210 },
        { title: 'Hawaii', Democratic: 30, Republic: 20, Ind: 50 },
        { title: 'Alabama', Democratic: 30, Republic: 50, Ind: 0 },
    ]

    useEffect(() => {
        axios.get("https://pankhay.com/thewhitehousegame/public/api/getVoterPartyCount",
            {
                headers: {
    ...
    return (
        <div className='w-10/12 m-auto relative'>
            {tooltip && <div className='svgModal py-5 shadow-md shadow-black px-5 rounded-[10px]' >
                <h1 className='text-[35px] orbit7 text-center text-white mb-5'>{step}</h1>
            ...
            <svg className='w-full relative' viewBox="0 0 1020 593" fill="none" xmlns="http://www.w3.org/2000/svg">
