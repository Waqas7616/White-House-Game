        ...
        <div className="bg-[#1c2452]  rounded-lg">
          ...
          <div className="flex justify-center items-center text-center pt-3 lg:pt-5 mr-7 lg:mr-0">
            <div className="inline-flex items-center">
              ...
              <label
                className="mt-px font-poppins text-white cursor-pointer select-none text-[9px] whitespace-nowrap lg:text-[16px]"
                htmlFor="react"
              >
          ...
          <div className="flex justify-center items-center text-center pt-5 mx-14">
            <div className="inline-flex items-center">
              ...
              <label
                className="mt-px font-poppins text-white cursor-pointer select-none text-[9px] whitespace-nowrap lg:text-[14px] "
                htmlFor="react"
              >
          ...
          <div className="flex justify-center pb-10 mt-10 ">
            <button
              ...
              className="rounded-lg px-5 py-3 bg-red-500 w-[250px] h-[50px] text-white font-poppins"
            >
              Next
            </button>
          </div>
