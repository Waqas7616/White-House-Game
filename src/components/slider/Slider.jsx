            ...
            <Slider {...settings}>
              {data?.map((item, index) => (
                ...
                >
                  ...
                  <h5 className="poppins5 text-[12px] text-left mt-2 sm:text-[15px] md:text-[15px] lg:text-[15px] xl:text-[15px] ml-5 sm:ml-8 md:ml-8  xl:text-center xl:ml-1 text-blackColor">
